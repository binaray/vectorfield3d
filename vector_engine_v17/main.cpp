...
{
	"resources/hw_alps/drakeq_ft.tga",
	"resources/hw_alps/drakeq_bk.tga",
	"resources/hw_alps/drakeq_up.tga",
	"resources/hw_alps/drakeq_dn.tga",
	"resources/hw_alps/drakeq_rt.tga",
	"resources/hw_alps/drakeq_lf.tga",
};
...
void setupSystems() {
	...
	shader = new Shader("shaders/6.2.cubemaps.vs", "shaders/6.2.cubemaps.fs");
	skyboxShader = new Shader("shaders/6.2.skybox.vs", "shaders/6.2.skybox.fs");
	shader->use();
